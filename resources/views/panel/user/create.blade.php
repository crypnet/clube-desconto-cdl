        ...
        <form action="{{ route('users.store') }}"
            ...
            <div class="tile">
                <div class="tile-title-w-btn">
                    <h3 class="tile-title">@lang('panel.text.create_m', ['value' => trans('panel.text.user')])</h3>
                    <p>
                        <button type="submit"
                                class="btn btn-primary icon-btn"
                                data-toggle="tooltip"
                                title="@lang('panel.text.store', ['value' => trans('panel.text.user')])">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control"
                                        ...
                                        id="role">
                                    @foreach ($roles as $r)
                                        <option value="{{ $r->id }}" {{ old('role') === $r->id ? 'selected="selected"' : '' }}>
                                            {{ $r->name }}
                                        </option>
                                    @endforeach
                                </select>
